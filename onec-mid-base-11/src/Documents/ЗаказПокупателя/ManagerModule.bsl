...
//Добавляет печатные формы в подменю Печать.
//
//Параметры:
//	 НастройкиОбъекта - Структура - настройки печати объекта, подключенного к подсистеме печати 
...
//
//Параметры:
//   МассивОбъектов - Массив из Строка - Набор ссылок на объекты которые нужно распечатать.
//   ПараметрыПечати - Структура - произвольные параметры, переданные при вызове команды печати.
//   КоллекцияПечатныхФорм - ТаблицаЗначений - Сформированные табличные документы.
//   ОбъектыПечати - СписокЗначений из ЛюбаяСсылка-Строка - соответствие объектов именам областей табличного документа.
